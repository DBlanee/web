...
<body>
    ...
    echo "<br> \$yazi İçeriğinin Büyük Harfle Yazılması: " . $byazi = strtoupper($yazi);
    echo "<br> \$yazi İçeriğinin Büyük Harfle Yazılması: " . $byazi = mb_strtoupper($yazi);

    //İçeriğin Küçük Harfe Dönüştürülmesi
    echo "<br> \$yazi İçeriğinin Küçük Harfle Yazılması: " . $kucuk_yazi = strtolower($byazi);
    echo "<br> \$yazi İçeriğinin Küçük Harfle Yazılması: " . $kucuk_yazi = mb_strtolower($byazi);
    ...
    /* Uygulama
        Veri tabanından gelen 2021-11-20 değerini 20-11-2021 şeklinde ekrana yazdırınız.
    */
    echo "<br>";
    $tarih = "2021-11-20";
    ...
    echo "<br>";
    echo " İmplode IBan:" . implode("_", $yeniiban);

    echo "<br> Foreach IBAN:";
    foreach ($yeniiban as $bölüm) {
        echo "$bölüm ";
    }
